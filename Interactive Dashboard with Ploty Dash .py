...
def get_pie_chart(entered_site):    
    if entered_site == 'ALL':
        ...
        site_selected  = spacex_df.loc[spacex_df['Launch Site'] == entered_site]
        fig = px.pie(
                site_selected,
                names = 'class',
...
def get_scatter_chart(entered_site,payload_slider):
    if entered_site == 'ALL':
        ...
        df  = spacex_df
        in_range = (df['Payload Mass (kg)'] > low) & (df['Payload Mass (kg)'] < high)
        fig = px.scatter(
            df[in_range], x="Payload Mass (kg)", y="class",
